...
In-person conferences for DevOps, Cloud & Automation engineers.
...
1. Add the conference to the home page
    1. Upload the splash screen
        1. Put it in `assets/images/events/devopsnotdead-2026-tokyo-q1.jpeg`
...
events:
  ...
  - name: DevOpsNotDead Tokyo 2026 Q1
    location: Tokyo, Japan
    photo_url: ./assets/images/events/devopsnotdead-2026-tokyo-q1.jpeg
    url: ./2026-tokyo-q1/
...
```